function script_REDUCE_SHIFT5_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
exp_name = 'REDUCE_SHIFT5_caltech';
...
dataset                     = Dataset.caltech_REDUCE_SHIFT5_trainval(dataset, 'train');
