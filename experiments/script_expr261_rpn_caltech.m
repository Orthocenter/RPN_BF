function script_expr261_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
exp_name = 'expr261_caltech';

% do validation, or not
opts.do_val                 = false;
opts.snapshot_interval      = 10000;
% model
...
%dataset                     = Dataset.caltech_expr261_trainval(dataset, 'train');
% dataset                     = Dataset.caltech_test(dataset, 'test', false);
dataset                     = Dataset.caltech_val(dataset, 'val');
...
cache_name = 'caltech';
for i = 8:8
    model.stage1_rpn.output_model_file = strcat('/home/ubuntu/RPN_BF4/output/expr261_caltech/rpn_cachedir/rpn_caltech_vgg_16layers_stage1_rpn/train/iter_', num2str(i * 10000))
    model.stage1_rpn.cache_name = strcat(model.stage1_rpn.cache_name, num2str(i))
    method_name = strcat('RPN-expr261-val-', num2str(i * 10000));
