function script_REDUCE_SHIFT3_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
exp_name = 'REDUCE_SHIFT3_caltech';
...
dataset                     = Dataset.caltech_REDUCE_SHIFT3_trainval(dataset, 'train');
