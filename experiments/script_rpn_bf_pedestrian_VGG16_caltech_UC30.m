function script_rpn_bf_pedestrian_VGG16_caltech_UC30()
close all;
clc;
%clear mex;
...
%% -------------------- TESTING --------------------
im_names = {'UC30/test_0.jpg', 'UC30/test_1.jpg', 'UC30/test_10.jpg', 'UC30/test_11.jpg', 'UC30/test_12.jpg', 'UC30/test_13.jpg', 'UC30/test_14.jpg', 'UC30/test_15.jpg', 'UC30/test_16.jpg', 'UC30/test_17.jpg', 'UC30/test_18.jpg', 'UC30/test_19.jpg','UC30/test_2.jpg','UC30/test_20.jpg', 'UC30/test_21.jpg', 'UC30/test_22.jpg', 'UC30/test_23.jpg', 'UC30/test_24.jpg', 'UC30/test_25.jpg', 'UC30/test_26.jpg', 'UC30/test_27.jpg', 'UC30/test_28.jpg', 'UC30/test_29.jpg', 'UC30/test_3.jpg', 'UC30/test_30.jpg', 'UC30/test_4.jpg', 'UC30/test_5.jpg', 'UC30/test_6.jpg', 'UC30/test_7.jpg', 'UC30/test_8.jpg', 'UC30/test_9.jpg'};

fid = fopen(fullfile(pwd, 'UC30_Dets.txt'), 'w');
...
for j = 1:length(im_names)
    ...
    bbs_ = bbs
    bbs_(:, 3) = bbs_(:, 3) - bbs_(:, 1);
    bbs_(:, 4) = bbs_(:, 4) - bbs_(:, 2);
    ...
    saveas(f__, fullfile(pwd, strcat(im_names{j}, '_result.png')));
    pause(0.1);
end
