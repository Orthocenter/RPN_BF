function script_expr36_2_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
dataset                     = Dataset.caltech_expr36_trainval(dataset, 'train');
...
model.stage1_rpn.output_model_file = '~/RPN_BF/output/expr36_2_caltech/rpn_cachedir/rpn_caltech_vgg16layers_stage1_rpn/train/final';

%% test
cache_name = 'caltech';
method_name = 'RPN-expr36_2';
