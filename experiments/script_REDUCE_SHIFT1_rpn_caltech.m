function script_REDUCE_SHIFT1_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
exp_name = 'REDUCE_SHIFT1_caltech';
...
% cache base
cache_base_proposal         = 'rpn_caltech_vgg_16layers_reduce_shift1';
% train/test data
dataset                     = [];
% use_flipped                 = true;
% dataset                     = Dataset.caltech_trainval(dataset, 'train', use_flipped);
dataset                     = Dataset.caltech_REDUCE_SHIFT1_trainval(dataset, 'train');
