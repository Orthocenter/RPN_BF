function script_REDUCE_SHIFT4_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
exp_name = 'REDUCE_SHIFT4_caltech';
...
dataset                     = Dataset.caltech_REDUCE_SHIFT4_trainval(dataset, 'train');
