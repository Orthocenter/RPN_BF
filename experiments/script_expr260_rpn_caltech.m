function script_expr260_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
%dataset                     = Dataset.caltech_expr260_trainval(dataset, 'train');
...
cache_name = 'caltech';
for i = 8:8
    model.stage1_rpn.output_model_file = strcat('/home/ubuntu/RPN_BF4/output/expr260_caltech/rpn_cachedir/rpn_caltech_vgg_16layers_stage1_rpn/train/iter_', num2str(i * 10000))    
    model.stage1_rpn.cache_name = strcat(model.stage1_rpn.cache_name, num2str(i))
    method_name = strcat('RPN-expr260-val-', num2str(i * 10000));
