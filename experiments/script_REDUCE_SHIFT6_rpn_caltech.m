function script_REDUCE_SHIFT6_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
exp_name = 'REDUCE_SHIFT6_caltech';
...
dataset                     = Dataset.caltech_REDUCE_SHIFT6_trainval(dataset, 'train');
