function script_NOISE2_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
% cache base
cache_base_proposal         = 'rpn_caltech_vgg_16layers_noise2';
% train/test data
dataset                     = [];
% use_flipped                 = true;
% dataset                     = Dataset.caltech_trainval(dataset, 'train', use_flipped);
dataset                     = Dataset.caltech_NOISE2_trainval(dataset, 'train');
