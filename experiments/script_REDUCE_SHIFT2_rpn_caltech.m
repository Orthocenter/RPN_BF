function script_REDUCE_SHIFT2_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
exp_name = 'REDUCE_SHIFT2_caltech';
...
dataset                     = Dataset.caltech_REDUCE_SHIFT2_trainval(dataset, 'train');
