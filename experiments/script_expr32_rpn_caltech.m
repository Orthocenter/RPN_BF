function script_expr32_rpn_caltech()
% --------------------------------------------------------
% RPN_BF
...
%active_caffe_mex(opts.gpu_id, optsc.caffe_version);

exp_name = 'expr32_caltech';
...
dataset                     = Dataset.caltech_expr32_trainval(dataset, 'train');
